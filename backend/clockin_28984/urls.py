"""clockin_28984 URL Configuration
...
admin.site.site_header = "ClockIn"
admin.site.site_title = "ClockIn Admin Portal"
admin.site.index_title = "ClockIn Admin"

# swagger
api_info = openapi.Info(
    title="ClockIn API",
    default_version="v1",
    description="API documentation for ClockIn App",
)
